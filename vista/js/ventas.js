...
new class Venta {
    ...
    crearTablaVentas() {
        this.tablaVentasRealizadas = new Tabulator("#tabla-ventas-realizadas", {
            ajaxURL: util.URL,
            ajaxParams: {
                clase: 'Venta',
                accion: 'seleccionar2'
            ...
            columns: [{
                ...
                { title: "Total credito", field: "total_credito", width: 100, align: "right" },
                { title: "Total contado", field: "total_contado", width: 100, align: "right" },
                { title: "id_cliente", field: "id_cliente", width: 100, align: "right" },
                { title: "id_vendedor", field: "id_vendedor", align: "right" }
